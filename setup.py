...
setup(
    name=name,  # Required
    version=get_version("{}/__init__.py".format(name.replace('-', '_'))),  # Required
    # This is a one-line description or tagline of what your project does.
    description="validate complex json data against rules you defined",  # Required
    ...
    keywords="validate,json",  # Optional
